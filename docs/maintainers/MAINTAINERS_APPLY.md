# Bushido Maintainers Application

Bushido is growing fast, with more contributors, PRs, and ideas than ever. To keep things moving smoothly, we're looking for new maintainers.
...
- 3+ merged PRs to Bushido (filters, fixes, docs — all contributions count)
...
1. Open a discussion in [tedorigawa001/TokenReductionTool Maintainers Applications · Discussions · GitHub](https://github.com/tedorigawa001/TokenReductionTool/discussions/categories/maintainers-applications) titled **Maintainer Application: [Your GitHub Handle]**
2. In your application, include:
   ...
   - Your PRs that have been accepted in Bushido
...
- A review of your ecosystem experience and understanding of Bushido concepts
...
- Maintain consistency with the rest of the Bushido ecosystem
...
Core Maintainers are responsible for the core of Bushido. They have a broader scope and higher responsibilities and permissions, including:
...
If you enjoy contributing and want to help Bushido scale in a healthy way, we'd be excited to have you onboard 🚀
