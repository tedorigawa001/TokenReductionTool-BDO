...
## Purpose
Core infrastructure shared by all Bushido command modules. Every filter, tracker, and command handler depends on these modules. No inward dependencies — leaf in the dependency graph (no circular imports possible).
